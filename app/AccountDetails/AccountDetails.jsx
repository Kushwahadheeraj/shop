          ...
          <div className="md:w-1/3 border-r px-8 py-8 flex flex-col items-center">
            ...
            <nav className="w-full">
              <ul className="space-y-1 text-sm">
                ...
                <li>
                  <Link href="/Address" className="block hover:bg-gray-100 pl-2 py-1 cursor-pointer">
                    ADDRESSES
                  </Link>
                </li>
                <li>
          ...
          <div className="md:w-2/3 px-8 py-8">
            <form className="space-y-4">
              ...
              <div>
                ...
                <Input type="text" value="dheerajkushwaha123" readOnly />
              ...
              <div>
                ...
                <Input type="email" value="dheeraj01702001@gmail.com" readOnly />
              </div>
              ...
              <Button className="bg-yellow-400 hover:bg-yellow-500 text-white font-bold mt-4" type="submit">
                SAVE CHANGES
              </Button>
            </form>
          </div>
