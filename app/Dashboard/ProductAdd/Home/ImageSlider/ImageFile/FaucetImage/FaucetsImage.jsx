...
const dataSlider = [
  {
    ...
    buttonText: 'Shop Now',
    cssClasses:
      'text-white text-xl border-2 border-white py-1 px-5 hover:bg-white hover:text-gray-900',
    mainText: 'CLASSIO LUXURY FAUCETS',
    descText:
      'Your Bathroom can be your heaven and aur job is to deliver you the finest quality of Sanitary Wares',
    subText: 'Upto 20% OFF',
  },
];
const FaucetsImage = () => {
      ...
      {dataSlider.map((slide, index) => (
        <div key={index} className='relative'>
          ...
          <div className='absolute inset-0 lg:ml-36 lg:w-[422px] w-[220px] flex flex-col justify-center lg:text-center lg:items-center text-white lg:p-4'>
            ...
            <button className='mt-4 border-2 border-white text-white lg:text-lg text-sm w-36 antialiased  text-bold px-4 lg:px-6 py-1 hover:bg-white hover:text-black'>
              {slide.buttonText}
            </button>
          </div>
        </div>
