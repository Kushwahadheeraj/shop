...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add CentreShutterLocks Product</h2>)
  ...
  const handleSubmit = async e => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "/electrical/Centre Shutter Locks", {
        method: "POST",
        body: data,
      });
