...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add ClipOnSoftHinge4Hole Product</h2>)
  ...
  const [form, setForm] = useState({
    ...
    price: "",
    totalProduct: "",
    category: "Clip On Soft Hinge4 Hole",
    tag: "",
    photos: [],
  });
  ...
  const handleSubmit = async e => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "/electrical/Clip On Soft Hinge4 Hole", {
        method: "POST",
        body: data,
      });
