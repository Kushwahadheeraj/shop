...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add HeavyDutyDrawerSlides Product</h2>)
  const [form, setForm] = useState({
    ...
    price: "",
    totalProduct: "",
    category: "Heavy Duty Drawer Slides",
    tag: "",
    photos: [],
  });
  ...
  const handleSubmit = async e => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "/electrical/Heavy Duty Drawer Slides", {
        method: "POST",
        body: data,
      });
