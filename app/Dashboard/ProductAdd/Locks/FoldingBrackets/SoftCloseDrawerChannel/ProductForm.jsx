...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add SoftCloseDrawerChannel Product</h2>)
  ...
  const [form, setForm] = useState({
    ...
    price: "",
    totalProduct: "",
    category: "Soft Close Drawer Channel",
    tag: "",
    photos: [],
  });
  ...
  const handleSubmit = async e => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "/electrical/Soft Close Drawer Channel", {
        method: "POST",
        body: data,
      });
