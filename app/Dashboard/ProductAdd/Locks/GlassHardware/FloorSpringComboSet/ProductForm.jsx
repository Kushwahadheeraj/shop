...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add FloorSpringComboSet Product</h2>)
  ...
  const [form, setForm] = useState({
    ...
    price: "",
    totalProduct: "",
    category: "Floor Spring Combo Set",
    tag: "",
    photos: [],
  });
  ...
  const handleSubmit = async e => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "/electrical/Floor Spring Combo Set", {
        method: "POST",
        body: data,
      });
