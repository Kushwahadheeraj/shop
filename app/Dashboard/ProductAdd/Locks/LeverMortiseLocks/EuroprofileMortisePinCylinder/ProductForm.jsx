...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add EuroprofileMortisePinCylinder Product</h2>)
  ...
  const [form, setForm] = useState({
    ...
    price: "",
    totalProduct: "",
    category: "Europrofile Mortise Pin Cylinder",
    tag: "",
    photos: [],
  });
  ...
  const handleSubmit = async e => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "/electrical/Europrofile Mortise Pin Cylinder", {
        method: "POST",
        body: data,
      });
