...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add EuroprofileMortisePinCylinderWithMasterKey Product</h2>)
  ...
  const [form, setForm] = useState({
    ...
    price: "",
    totalProduct: "",
    category: "Europrofile Mortise Pin Cylinder With Master Key",
    tag: "",
    photos: [],
  });
