...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add TowyLowHeightDesign Product</h2>)
  ...
  const [form, setForm] = useState({
    ...
    price: "",
    totalProduct: "",
    category: "Towy Low Height Design",
    tag: "",
    photos: [],
  });
  ...
  const handleSubmit = async e => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "/electrical/Towy Low Height Design", {
        method: "POST",
        body: data,
      });
