...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add AllureRossetteSeries Product</h2>)
  ...
  const [form, setForm] = useState({
    ...
    price: "",
    totalProduct: "",
    category: "Allure Rossette Series",
    tag: "",
    photos: [],
  });
  ...
  const handleSubmit = async e => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "/electrical/Allure Rossette Series", {
        method: "POST",
        body: data,
      });
