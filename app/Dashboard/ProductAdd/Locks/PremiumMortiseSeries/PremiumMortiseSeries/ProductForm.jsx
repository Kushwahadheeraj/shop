...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add PremiumMortiseSeries Product</h2>)
  ...
  const [form, setForm] = useState({
    ...
    price: "",
    totalProduct: "",
    category: "Premium Mortise Series",
    tag: "",
    photos: [],
  });
  ...
  const handleSubmit = async e => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "/electrical/Premium Mortise Series", {
        method: "POST",
        body: data,
      });
