...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add PinCylinderRimLocks Product</h2>)
  ...
  const [form, setForm] = useState({
    ...
    price: "",
    totalProduct: "",
    category: "Pin Cylinder Rim Locks",
    tag: "",
    photos: [],
  });
  ...
  const handleSubmit = async e => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "/electrical/Pin Cylinder Rim Locks", {
        method: "POST",
        body: data,
      });
