...
export default function ProductForm() {
  return (<h2 className="text-xl font-bold mb-2">Add Series5HotelierSeries Product</h2>)
  ...
  const [form, setForm] = useState({
    ...
    price: "",
    totalProduct: "",
    category: "Series5 Hotelier Series",
    tag: "",
    photos: [],
  });
  ...
  const handleSubmit = async e => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "/electrical/Series5 Hotelier Series", {
        method: "POST",
        body: data,
      });
