...
export default function ProductForm() {
  ...
  const handleSubmit = async e => {
    ...
    const res = await fetch(`${API_BASE_URL}/sanitary/lemon-bath-fittings-bathroom-accessories-bathroom-accessories/create`, {
      method: "POST",
      body: formData,
    });
    if (res.ok) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-xl mx-auto p-4 bg-white rounded shadow">
      <h2 className="text-xl font-bold mb-2">Add LemonBathroomAccessories Product</h2>
