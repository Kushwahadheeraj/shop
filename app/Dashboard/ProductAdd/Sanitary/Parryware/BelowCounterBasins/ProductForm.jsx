...
export default function ProductForm() {
  ...
  const handleSubmit = async e => {
    ...
    const res = await fetch(API_BASE_URL + "/sanitary/parryware-below-counter-basins-below-counter-basins/create", {
      method: "POST",
      body: formData,
    });
    if (res.ok) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-xl mx-auto p-4 bg-white rounded shadow">
      <h2 className="text-xl font-bold mb-2">Add BelowCounterBasins Product</h2>
