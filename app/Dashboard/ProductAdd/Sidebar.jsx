            ...
            subItemsNameComponent: [
              {
                ...
                path: '/Dashboard/ProductAdd/Hardware/Locks/Door%20Accessories/AluminiumTowerBolt',
              },
              {
                name: 'Ball Bearing Door Hinges',
                path: '/Dashboard/ProductAdd/Hardware/Locks/Door%20Accessories/BallBearingDoorHinges',
              },
              {
                name: 'Concealed Hinges',
                path: '/Dashboard/ProductAdd/Hardware/Locks/Door%20Accessories/ConcealedHinges',
              },
              {
                name: 'Door Eye',
                path: '/Dashboard/ProductAdd/Hardware/Locks/Door%20Accessories/DoorEye',
              },
              {
                name: 'Door Stopper',
                path: '/Dashboard/ProductAdd/Hardware/Locks/Door%20Accessories/DoorStopper',
              },
              {
                name: 'HINGES',
                path: '/Dashboard/ProductAdd/Hardware/Locks/Door%20Accessories/HINGES',
              },
              {
                name: 'Magnetic Door Stoppers',
                path: '/Dashboard/ProductAdd/Hardware/Locks/Door%20Accessories/MagneticDoorStoppers',
              },
              {
                name: 'Wooden Sliding Door Fittings',
                path: '/Dashboard/ProductAdd/Hardware/Locks/Door%20Accessories/WoodenSlidingDoorFittings',
              },
            ],
          },
          {
            ...
            subItemsNameComponent: [
              {
                name: 'Door Closers',
                path: '/Dashboard/ProductAdd/Locks/Door%20Controls/Door%20Closers',
              },
              {
                name: 'Door Stopper',
                path: '/Dashboard/ProductAdd/Locks/Door%20Controls/Door%20Stopper',
              },
              {
                name: 'Hydraulic Door Closers',
                path: '/Dashboard/ProductAdd/Locks/Door%20Controls/Hydraulic%20Door%20Closers',
              },
            ],
          },
          {
            ...
            subItemsNameComponent: [
              {
                name: 'Door King',
                path: '/Dashboard/ProductAdd/Locks/Door%20Controls/Door%20King',
              },
              {
                name: 'Door Pulls',
                path: '/Dashboard/ProductAdd/Locks/Door%20Controls/Door%20Pulls',
              },
            ],
          },
          {
