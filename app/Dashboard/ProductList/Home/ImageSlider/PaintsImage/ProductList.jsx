...
export default function ProductList() {
  ...
  const handleEdit = (product) => {
    router.push("/Dashboard/ProductAdd/Home/ImageSlider/PaintsImage?id=" + product._id);
  };
  ...
  const handleView = (product) => {
    router.push(`/Dashboard/ProductView/home/imageSlider/paintsImage/${product._id}`);
  };

  const handleAddNew = () => {
    router.push("/Dashboard/ProductAdd/Home/ImageSlider/PaintsImage");
  };
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <CardTitle>Paints Image Slider Items</CardTitle>
            </div>
