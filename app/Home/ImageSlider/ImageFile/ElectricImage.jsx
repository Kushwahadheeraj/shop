   ...
   <>
    {dataSlider.map((slide, index) => (
        <div key={index} className="relative">
          ...
          <div className="flex flex-col text-center gap-2 p-6 md:p-12 inset-0
          justify-center items-center  text-black absolute z-40
           lg:w-[800px] w-[200px] -translate-x-1/2 left-1/2 space-x-2">
            ...
            <button className="mt-4 border-2 border-black text-black lg:text-lg text-sm antialiased  text-bold px-6 py-1 hover:bg-white hover:text-black">{slide.buttonText}</button>
          </div>
        </div>
      ))}
   </>
