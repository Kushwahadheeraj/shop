...
export default function Shop() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto py-8 mt-36 px-4 flex flex-col lg:flex-row gap-8">
      {/* Sidebar */}
                ...
                <div key={cat}>
                  {subcategories ? (
                          ...
                          if (typeof sub === "string") {
                            return (
                              <Link
                                ...
                                className="block py-2 text-xs text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:underline transition-all duration-200 rounded-md px-2 ml-2"
                              >
                                {sub}
                              </Link>
                            );
                            ...
                            return (
                              <Collapsible key={sub.label}>
                                <CollapsibleTrigger className="flex items-center w-full justify-between py-2 text-xs font-semibold text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-colors rounded-md px-2 ml-2 group">
                                  <span>{sub.label}</span>
                                    ...
                                    if (typeof item === "string") {
                                      return (
                                        <Link
                                          ...
                                          className="block py-1 text-xs text-gray-600 hover:text-blue-600 hover:bg-blue-50 hover:underline transition-all duration-200 rounded-md px-2 ml-4"
                                        >
                                          {item}
                                        </Link>
                                      );
                                      ...
                                      return (
                                        <Collapsible key={item.label}>
                                          <CollapsibleTrigger className="flex items-center w-full justify-between py-1 text-xs font-semibold text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-colors rounded-md px-2 ml-4 group">
                                          ...
                                          <CollapsibleContent className="pl-4">
                                            {item.sub.map((subItem) => (
                                              <Link
                                                ...
                                                className="block py-1 text-xs text-gray-500 hover:text-blue-600 hover:bg-blue-50 hover:underline transition-all duration-200 rounded-md px-2 ml-6"
                                              >
                                                {subItem}
                                              </Link>
                                            ))}
                    ...
                    <Link
                      ...
                      className="block py-3 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200 font-medium rounded-md px-2 group"
                    >
                      <span className="group-hover:text-blue-600">{cat}</span>
                    </Link>
                  )}
