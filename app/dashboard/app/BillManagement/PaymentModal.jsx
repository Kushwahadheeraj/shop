      ...
      <div className="bg-white rounded-lg shadow-xl max-w-lg w-full max-h-[95vh] overflow-y-auto mx-auto">
        ...
        <div className="p-4 sm:p-6 border-b bg-gray-50">
          <div className="text-xs sm:text-sm text-gray-600 space-y-1">
            <p><span className="font-medium">Bill:</span> <span className="truncate">{bill.billNumber}</span></p>
            <p><span className="font-medium">Shop:</span> <span className="truncate">{bill.shopName}</span></p>
            {bill.isCombinedBill ? (
              <>
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 sm:space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-7 sm:pl-8 pr-3 py-2 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 ${
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              {['cash', 'upi', 'cheque'].map((method) => (
                <button
                  ...
                  className={`flex flex-col items-center p-2 sm:p-4 border-2 rounded-lg transition-all duration-200 ${
                ...
                >
                  ...
                  <span className="text-xs sm:text-sm font-medium mt-1 sm:mt-2">{getMethodLabel(method)}</span>
                </button>
              ))}
            </div>
            {errors.method && (
          ...
          <div>
            ...
            />
            {errors.paymentDate && (
              <p className="text-red-500 text-xs sm:text-sm mt-1">{errors.paymentDate}</p>
            )}
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-3 sm:p-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-sm sm:text-base font-medium text-blue-900">AI Receipt Scanning</span>
            </div>
            ...
            <button
              type="button"
              className="flex items-center space-x-2 px-3 sm:px-4 py-2 text-xs sm:text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-sm"
            >
          ...
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 rounded-lg p-3 sm:p-4">
            ...
            <div className="space-y-2 text-xs sm:text-sm">
                ...
                <div className="border-t border-gray-300 pt-2 mt-2">
                  ...
                  {formData.customerName && (
                    <div className="flex justify-between py-1">
                      ...
                      <span className="font-medium text-gray-900 truncate ml-2">{formData.customerName}</span>
                    </div>
                  )}
                  {formData.billId && (
                    <div className="flex justify-between py-1">
                      <span className="text-gray-600">Bill ID:</span>
                      <span className="font-medium text-gray-900 truncate ml-2">{formData.billId}</span>
                    </div>
                  )}
                  {formData.transactionId && (
                    <div className="flex justify-between py-1">
                      <span className="text-gray-600">Transaction ID:</span>
                      <span className="font-medium text-gray-900 truncate ml-2">{formData.transactionId}</span>
                    </div>
                  )}
                </div>
              )}
              ...
              <div className="border-t border-gray-300 pt-2 mt-2">
                <div className="flex justify-between font-bold text-sm sm:text-base py-1">
