...
const InvoiceTemplates = ({ onClose, onSelectTemplate, selectedTemplate }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-100/95 flex items-center justify-center z-50 p-3 sm:p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[92vh] overflow-hidden flex flex-col">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between px-4 sm:px-6 py-4 sm:py-5 border-b bg-white gap-3 relative">
          <div>
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-full hover:bg-gray-100 text-gray-500 hover:text-gray-700 transition-colors self-start sm:self-center absolute right-3 sm:right-5 top-3 sm:top-4"
