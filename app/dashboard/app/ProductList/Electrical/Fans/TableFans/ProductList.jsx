...
export default function ProductList() {
  ...
  const API_URL = `${API_BASE_URL}/electrical/tablefans`;
  ...
  const handleEdit = (product) => {
    router.push("/ProductAdd/Electrical/Fans/TableFans?id=" + product._id);
  };
  ...
  const handleView = (product) => {
    router.push(`/ProductView/electrical/fans/tablefans/${product._id}`);
  };

  const handleAddNew = () => {
    router.push("/ProductAdd/Electrical/Fans/TableFans");
  };
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      <div className="mb-4 sm:mb-6 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 rounded-lg p-4 sm:p-6 text-white shadow-lg">
        <div className="flex items-center gap-2 sm:gap-3 mb-2">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold">Electrical - Fans - TableFans Products</h1>
        </div>
      ...
      <Card>
        <CardHeader className="p-3 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
            <div className="flex items-center gap-4">
              ...
              <CardTitle className="text-lg sm:text-xl">Electrical - Fans - TableFans Products</CardTitle>
            </div>
        ...
        <CardContent className="p-3 sm:p-6">
          ...
          <ProductTable
            ...
            onView={handleView}
            category="Electrical - Fans - TableFans Products"
          />
        </CardContent>
      </Card>
    </div>
