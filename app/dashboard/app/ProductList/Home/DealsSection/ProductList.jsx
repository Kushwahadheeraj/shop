...
export default function ProductList() {
  ...
  const API_URL = `${API_BASE_URL}/home/deals`;
  ...
  const handleAddNew = () => {
    router.push("/dashboard/app/ProductAdd/Home/DealsSection");
  };
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Deals Items</h1>
            <p className="text-sm text-gray-500">Manage your Deals section items</p>
          </div>
        </div>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Edit Deal Item</DialogTitle>
            <DialogDescription>
              Update the details of the selected deal item.
            </DialogDescription>
          </DialogHeader>
