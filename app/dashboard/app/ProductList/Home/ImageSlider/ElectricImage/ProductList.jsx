...
export default function ProductList() {
  ...
  const API_URL = `${API_BASE_URL}/home/imageSlider/electricImage`;
  ...
  const handleEdit = (product) => {
    router.push("/ProductAdd/Home/ImageSlider/ElectricImage?id=" + product._id);
  };
  ...
  const handleView = (product) => {
    router.push(`/ProductView/home/imageSlider/electricImage/${product._id}`);
  };

  const handleAddNew = () => {
    router.push("/ProductAdd/Home/ImageSlider/ElectricImage");
  };
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      <div className="mb-4 sm:mb-6 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 rounded-lg p-4 sm:p-6 text-white shadow-lg">
        <div className="flex items-center gap-2 sm:gap-3 mb-2">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold">Electric Image Slider Items</h1>
        </div>
      ...
      <Card>
        <CardHeader className="p-3 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
            <div className="flex items-center gap-4">
              <CardTitle className="text-lg sm:text-xl">Electric Image Slider Items</CardTitle>
            </div>
        ...
        <CardContent className="p-3 sm:p-6">
          ...
          <div className="mb-4">
            <input
              type="text"
              placeholder="Search by main text or sub text..."
              value={searchTerm}
                ...
                {filteredProducts.length === 0 ? (
                  <tr>
                    <td colSpan="5" className="border border-gray-200 px-4 py-8 text-center text-gray-500">
                      {searchTerm ? 'No items found matching your search.' : 'No image slider items found.'}
                    </td>
                  </tr>
                ) : (
      ...
      {deleteId && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-6">Are you sure you want to delete this image slider item? This action cannot be undone.</p>
