...
export default function ProductList() {
  ...
  const API_URL = `${API_BASE_URL}/home/toprateddeals`;
  ...
  const handleAddNew = () => {
    router.push("/dashboard/app/ProductAdd/Home/TopRatedDeals");
  };
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Top Rated Deals</h1>
            <p className="text-sm text-gray-500">Manage your Top Rated deals items</p>
          </div>
        </div>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Edit Top Rated Deal</DialogTitle>
            <DialogDescription>
              Update the details of the selected top rated deal.
            </DialogDescription>
          </DialogHeader>
