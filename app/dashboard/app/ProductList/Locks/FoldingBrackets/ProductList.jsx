...
export default function ProductList() {
  ...
  const API_URL = `${API_BASE_URL}/locks/folding-brackets`;
  ...
  const handleEdit = (product) => {
    router.push("/ProductAdd/Locks/FoldingBrackets?id=" + product._id);
  };
  ...
  const handleView = (product) => {
    router.push(`/ProductView/locks/foldingbrackets/${product._id}`);
  };

  const handleAddNew = () => {
    router.push("/ProductAdd/Locks/FoldingBrackets");
  };
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      <div className="mb-4 sm:mb-6 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 rounded-lg p-4 sm:p-6 text-white shadow-lg">
        <div className="flex items-center gap-2 sm:gap-3 mb-2">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold">Locks - FoldingBrackets Products</h1>
        </div>
      ...
      <Card>
        <CardHeader className="p-3 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
            <div className="flex items-center gap-4">
              ...
              <CardTitle className="text-lg sm:text-xl">Locks - FoldingBrackets Products</CardTitle>
            </div>
        ...
        <CardContent className="p-3 sm:p-6">
          ...
          <ProductTable
            ...
            onView={handleView}
            category="Locks - FoldingBrackets Products"
          />
        </CardContent>
      </Card>
    </div>
