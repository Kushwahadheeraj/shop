...
export default function ProductList() {
  ...
  const API_URL = `${API_BASE_URL}/pipe/apollo-pipes`;
  ...
  const handleEdit = (product) => {
    router.push("/ProductAdd/Pipe/ApolloPipes?id=" + product._id);
  };
  ...
  const handleView = (product) => {
    router.push(`/ProductView/pipe/Apollopipes/${product._id}`);
  };

  const handleAddNew = () => {
    router.push("/ProductAdd/Pipe/ApolloPipes");
  };
        ...
        <CardHeader className="p-3 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
            <div className="flex items-center gap-4">
              ...
              <CardTitle className="text-lg sm:text-xl">Pipe - ApolloPipes Products</CardTitle>
            </div>
