...
export default function ProductList() {
  ...
  const API_URL = `${API_BASE_URL}/sanitary/ss-toti`;
  ...
  const handleEdit = (product) => {
    router.push(`/ProductAdd/Sanitary/SSToti?id=${product._id}`);
  };
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      <div className="mb-4 sm:mb-6 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 rounded-lg p-4 sm:p-6 text-white shadow-lg">
        <div className="flex items-center gap-2 sm:gap-3 mb-2">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold">SS Toti Products</h1>
        </div>
        <p className="text-xs sm:text-sm text-gray-50">View and manage all SS Toti products</p>
      </div>
