...
const AddShopForm = ({ onClose, onSave }) => {
  const [formData, setFormData] = useState({
    name: '',
    address: '',
    category: 'simple', // 'simple' or 'other'
    contact: {
      phone: '',
      email: '',
      ownerName: ''
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {formData.category === 'simple' 
                      ? 'This shop will appear in Simple Bill management'
                      : 'This shop will not appear in Simple Bill management'}
                  </p>
                </div>
              </div>
            ...
            <div className="flex justify-end gap-4 pt-6 border-t">
              ...
              <button
                ...
                className="px-6 py-2 bg-gradient-to-r from-amber-500 via-amber-600 to-orange-600 text-white rounded-lg hover:bg-gradient-to-brdisabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
