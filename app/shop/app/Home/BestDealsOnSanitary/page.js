...
export default function BestDealsOnSanitaryPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        const res = await fetch(`${API_BASE_URL}/home/furnituredeals/get`);
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            Best Deals on Sanitary
          </h1>
          <p className="text-sm text-gray-500">
            All items added in the Best Deals on Sanitary section
          </p>
        </div>
        <Link
          href="/Home"
