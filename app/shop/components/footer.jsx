      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 border-b border-gray-700 pb-8">
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><Link href="/AccountDetails" className="hover:underline">- My Account</Link></li>
              <li><Link href="/payment" className="hover:underline">- Payment Options</Link></li>
              <li><Link href="/forgot-password" className="hover:underline">- Forget Password</Link></li>
            </ul>
          </div>
          {/* INFORMATION */}
          <div>
            ...
            <div className="w-8 border-b-2 border-gray-400 mb-2"></div>
            <ul className="space-y-1 text-sm">
              <li><Link href="/Tracking" className="hover:underline">- Track Your Order</Link></li>
              <li><Link href="/how-it-works" className="hover:underline">- How It Works</Link></li>
              <li><Link href="/gallery" className="hover:underline">- Gallery</Link></li>
              <li><Link href="/covid-19-faq" className="hover:underline">- COVID-19 FAQ</Link></li>
            </ul>
          </div>
          {/* WHY CHOOSE US */}
          <div>
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><Link href="/reseller-program" className="hover:underline">- Reseller Program</Link></li>
            </ul>
          </div>
          {/* POLICIES */}
          <div>
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><Link href="/return-refund-policy" className="hover:underline">- Return And Refund Policy</Link></li>
            </ul>
          </div>
          {/* DOWNLOAD OUR APP */}
          {/* <div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-8 pt-6 border-gray-700">
          ...
          <div className="flex flex-wrap gap-2 md:gap-3 justify-center md:justify-end">
            {/* Cash on Delivery */}
            <div className="bg-gray-700 px-2 py-1 md:px-3 md:py-2 rounded flex items-center gap-1 md:gap-2">
              <svg className="w-2.5 h-2.5 md:w-3 md:h-3 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
              </svg>
              <div className="text-gray-300 text-[10px] md:text-xs font-medium leading-tight">
                <div>CASH</div>
                <div>ON DEL.</div>
              </div>
            </div>
            ...
            {/* G Pay */}
            <div className="bg-gray-700 px-2 py-1 md:px-3 md:py-2 rounded flex items-center gap-1 md:gap-2">
              <svg className="w-2.5 h-2.5 md:w-3 md:h-3" viewBox="0 0 24 24">
                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/>
                <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
                <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/>
                <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/>
              </svg>
              <div className="text-gray-300 text-[10px] md:text-xs font-bold">G Pay</div>
            </div>
            ...
            <div className="bg-gray-700 px-2 py-1 md:px-3 md:py-2 rounded flex items-center gap-1 md:gap-2">
              ...
              <div className="text-gray-300 text-[10px] md:text-xs font-bold">VISA</div>
            </div>
            ...
            <div className="bg-gray-700 px-2 py-1 md:px-3 md:py-2 rounded flex items-center gap-1 md:gap-2">
              ...
              <div className="text-gray-300 text-[10px] md:text-xs font-bold">MasterCard</div>
            </div>
            ...
            {/* <div className="bg-gray-700 px-2 py-1 md:px-3 md:py-2 rounded flex items-center gap-1 md:gap-2">
              ...
              <div className="text-gray-300 text-[10px] md:text-xs font-bold whitespace-nowrap">Diners Club</div>
            </div> */}
          </div>
        </div>
      </div>
