...
export default function Header() {
  ...
  useEffect(() => {
    const searchCategories = () => {
      ...
      const categories = [
        ...
        { name: 'Waste Pipe', path: '/ShopPage/Sanitary/WastePipe', description: 'Waste Pipe', type: 'sub', parent: 'Sanitary' },
        { name: 'Sink/Wash Basin Jali', path: '/ShopPage/Sanitary/SinkWashBasinJali', description: 'Sink/Wash Basin Jali', type: 'sub', parent: 'Sanitary' },
        { name: 'Kitchen Bathroom Jali', path: '/ShopPage/Sanitary/KitchenBathroomJali', description: 'Kitchen Bathroom Jali', type: 'sub', parent: 'Sanitary' },
  { name: 'Bathroom Shop Stand', path: '/ShopPage/Sanitary/BathroomShopStand', description: 'Bathroom Shop Stand', type: 'sub', parent: 'Sanitary' },
  { name: 'Cistern', path: '/ShopPage/Sanitary/Cistern', description: 'Cistern', type: 'sub', parent: 'Sanitary' },
  { name: 'Seat Cover', path: '/ShopPage/Sanitary/SeatCover', description: 'Seat Cover', type: 'sub', parent: 'Sanitary' },
  { name: 'Bathroom Faucets', path: '/ShopPage/Sanitary/Faucets', description: 'Bathroom Faucets', type: 'sub', parent: 'Sanitary' },
        ...
        { name: 'Delivery Pipe', path: '/ShopPage/Pipe/DeliveryPipe', description: 'Delivery Pipe', type: 'sub', parent: 'Pipe' },
        { name: 'Finolex Pipes', path: '/ShopPage/Pipe/FinolexPipes', description: 'Finolex Pipes', type: 'sub', parent: 'Pipe' },
        { name: 'Garden Pipe', path: '/ShopPage/Pipe/GardenPipe', description: 'Garden Pipe', type: 'sub', parent: 'Pipe' },
