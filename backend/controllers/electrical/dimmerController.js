...
exports.createDimmer = async (req, res) => {
  try {
    ...
    const product = new DimmerModel({ ...req.body, photos: photoUrls, category: 'dimmer' });
    await product.save();
...
exports.updateDimmer = async (req, res) => {
  try {
    ...
    const product = await DimmerModel.findOneAndUpdate(
