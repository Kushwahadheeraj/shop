...
/**
 * Create a new Indicator product.
 */
exports.createIndicator = async (req, res) => {
  try {
    ...
    const product = new IndicatorModel({ ...req.body, photos: photoUrls, category: 'indicator' });
    await product.save();
...
/**
 * Update a Indicator product by ID.
 */
exports.updateIndicator = async (req, res) => {
  try {
    ...
    const product = await IndicatorModel.findOneAndUpdate(
