...
exports.createJacks = async (req, res) => {
  try {
    ...
    const product = new JacksModel({ ...req.body, photos: photoUrls, category: 'jacks' });
    await product.save();
...
exports.updateJacks = async (req, res) => {
  try {
    ...
    const product = await JacksModel.findOneAndUpdate(
