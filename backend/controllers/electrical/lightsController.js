...
exports.createLights = async (req, res) => {
  try {
    ...
    const product = new LightsModel({ ...req.body, photos: photoUrls, category: 'lights' });
    await product.save();
...
exports.updateLights = async (req, res) => {
  try {
    ...
    const product = await LightsModel.findOneAndUpdate(
