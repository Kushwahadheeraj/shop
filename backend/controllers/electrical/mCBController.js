...
exports.createMCB = async (req, res) => {
  try {
    ...
    const product = new MCBModel({ ...req.body, photos: photoUrls, category: 'mCB' });
    await product.save();
...
exports.updateMCB = async (req, res) => {
  try {
    ...
    const product = await MCBModel.findOneAndUpdate(
...
exports.getAllMCBs = async (req, res) => {
  try {
