...
/**
 * Create a new ModularSurfaceBox product.
 */
exports.createModularSurfaceBox = async (req, res) => {
  try {
    ...
    const product = new ModularSurfaceBoxModel({ ...req.body, photos: photoUrls, category: 'modularSurfaceBox' });
    await product.save();
...
/**
 * Update a ModularSurfaceBox product by ID.
 */
exports.updateModularSurfaceBox = async (req, res) => {
  try {
    ...
    const product = await ModularSurfaceBoxModel.findOneAndUpdate(
