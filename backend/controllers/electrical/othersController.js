...
exports.createOthers = async (req, res) => {
  try {
    ...
    const product = new OthersModel({ ...req.body, photos: photoUrls, category: 'others' });
    await product.save();
...
exports.updateOthers = async (req, res) => {
  try {
    ...
    const product = await OthersModel.findOneAndUpdate(
