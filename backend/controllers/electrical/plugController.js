...
exports.createPlug = async (req, res) => {
  try {
    ...
    const product = new PlugModel({ ...req.body, photos: photoUrls, category: 'plug' });
    await product.save();
...
exports.updatePlug = async (req, res) => {
  try {
    ...
    const product = await PlugModel.findOneAndUpdate(
