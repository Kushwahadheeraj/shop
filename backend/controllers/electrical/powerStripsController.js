...
/**
 * Create a new PowerStrips product.
 */
exports.createPowerStrips = async (req, res) => {
  try {
    ...
    const product = new PowerStripsModel({ ...req.body, photos: photoUrls, category: 'powerStrips' });
    await product.save();
...
/**
 * Update a PowerStrips product by ID.
 */
exports.updatePowerStrips = async (req, res) => {
  try {
    ...
    const product = await PowerStripsModel.findOneAndUpdate(
