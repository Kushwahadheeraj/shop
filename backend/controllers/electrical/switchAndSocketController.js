...
/**
 * Create a new SwitchAndSocket product.
 */
exports.createSwitchAndSocket = async (req, res) => {
  try {
    ...
    const product = new SwitchAndSocketModel({ ...req.body, photos: photoUrls, category: 'switchAndSocket' });
    await product.save();
...
/**
 * Update a SwitchAndSocket product by ID.
 */
exports.updateSwitchAndSocket = async (req, res) => {
  try {
    ...
    const product = await SwitchAndSocketModel.findOneAndUpdate(
