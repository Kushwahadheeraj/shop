...
exports.createBallBearingDoorHinges = async (req, res) => {
  try {
    ...
    const product = new BallBearingDoorHingesModel({ ...req.body, photos: photoUrls, category: 'BallBearingDoorHinges' });
    await product.save();
...
exports.updateBallBearingDoorHinges = async (req, res) => {
  try {
    ...
    const product = await BallBearingDoorHingesModel.findOneAndUpdate(
