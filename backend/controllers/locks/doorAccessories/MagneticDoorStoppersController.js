...
exports.createMagneticDoorStoppers = async (req, res) => {
  try {
    ...
    const product = new MagneticDoorStoppersModel({ ...req.body, photos: photoUrls, category: 'MagneticDoorStoppers' });
    await product.save();
...
exports.updateMagneticDoorStoppers = async (req, res) => {
  try {
    ...
    const product = await MagneticDoorStoppersModel.findOneAndUpdate(
