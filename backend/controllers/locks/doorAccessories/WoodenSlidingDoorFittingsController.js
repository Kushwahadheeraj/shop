...
exports.createWoodenSlidingDoorFittings = async (req, res) => {
  try {
    ...
    const product = new WoodenSlidingDoorFittingsModel({ ...req.body, photos: photoUrls, category: 'WoodenSlidingDoorFittings' });
    await product.save();
...
exports.updateWoodenSlidingDoorFittings = async (req, res) => {
  try {
    ...
    const product = await WoodenSlidingDoorFittingsModel.findOneAndUpdate(
