...
exports.createHydraulicDoorClosers = async (req, res) => {
  try {
    ...
    const product = new HydraulicDoorClosersModel({ ...req.body, photos: photoUrls, category: 'HydraulicDoorClosers' });
    await product.save();
...
exports.updateHydraulicDoorClosers = async (req, res) => {
  try {
    ...
    const product = await HydraulicDoorClosersModel.findOneAndUpdate(
