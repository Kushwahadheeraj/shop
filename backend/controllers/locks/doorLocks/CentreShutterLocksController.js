...
exports.createCentreShutterLocks = async (req, res) => {
  try {
    ...
    const product = new CentreShutterLocksModel({ ...req.body, photos: photoUrls, category: 'CentreShutterLocks' });
    await product.save();
...
exports.updateCentreShutterLocks = async (req, res) => {
  try {
    ...
    const product = await CentreShutterLocksModel.findOneAndUpdate(
