...
exports.createJemmyProofDoorLock = async (req, res) => {
  try {
    ...
    const product = new JemmyProofDoorLockModel({ ...req.body, photos: photoUrls, category: 'JemmyProofDoorLock' });
    await product.save();
...
exports.updateJemmyProofDoorLock = async (req, res) => {
  try {
    ...
    const product = await JemmyProofDoorLockModel.findOneAndUpdate(
