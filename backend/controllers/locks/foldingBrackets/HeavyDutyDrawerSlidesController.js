...
/**
 * Create a new HeavyDutyDrawerSlides product.
 */
exports.createHeavyDutyDrawerSlides = async (req, res) => {
  try {
    ...
    const product = new HeavyDutyDrawerSlidesModel({ ...req.body, photos: photoUrls, category: 'HeavyDutyDrawerSlides' });
    await product.save();
...
/**
 * Update a HeavyDutyDrawerSlides product by ID.
 */
exports.updateHeavyDutyDrawerSlides = async (req, res) => {
  try {
    ...
    const product = await HeavyDutyDrawerSlidesModel.findOneAndUpdate(
      { _id: req.params.id, category: 'HeavyDutyDrawerSlides' },
      update,
      { new: true }
    );
