...
exports.createSoftCloseDrawerChannel = async (req, res) => {
  try {
    ...
    const product = new SoftCloseDrawerChannelModel({ ...req.body, photos: photoUrls, category: 'SoftCloseDrawerChannel' });
    await product.save();
...
exports.updateSoftCloseDrawerChannel = async (req, res) => {
  try {
    ...
    const product = await SoftCloseDrawerChannelModel.findOneAndUpdate(
