...
exports.createEuroprofileMortisePinCylinderWithMasterKey = async (req, res) => {
  try {
    ...
    const product = new EuroprofileMortisePinCylinderWithMasterKeyModel({ ...req.body, photos: photoUrls, category: 'EuroprofileMortisePinCylinderWithMasterKey' });
    await product.save();
...
exports.updateEuroprofileMortisePinCylinderWithMasterKey = async (req, res) => {
  try {
    ...
    const product = await EuroprofileMortisePinCylinderWithMasterKeyModel.findOneAndUpdate(
