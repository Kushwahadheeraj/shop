...
exports.createSquareTypePadlock = async (req, res) => {
  try {
    ...
    const product = new SquareTypePadlockModel({ ...req.body, photos: photoUrls, category: 'SquareTypePadlock' });
    await product.save();
...
exports.updateSquareTypePadlock = async (req, res) => {
  try {
    ...
    const product = await SquareTypePadlockModel.findOneAndUpdate(
