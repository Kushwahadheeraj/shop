...
exports.createCornerFetchSeries = async (req, res) => {
  try {
    ...
    const product = new CornerFetchSeriesModel({ ...req.body, photos: photoUrls, category: 'CornerFetchSeries' });
    await product.save();
...
exports.updateCornerFetchSeries = async (req, res) => {
  try {
    ...
    const product = await CornerFetchSeriesModel.findOneAndUpdate(
