...
exports.createCombipackWith240mmEuroMortiseLock = async (req, res) => {
  try {
    ...
    const product = new CombipackWith240mmEuroMortiseLockModel({ ...req.body, photos: photoUrls, category: 'CombipackWith240mmEuroMortiseLock' });
    await product.save();
...
exports.updateCombipackWith240mmEuroMortiseLock = async (req, res) => {
  try {
    ...
    const product = await CombipackWith240mmEuroMortiseLockModel.findOneAndUpdate(
