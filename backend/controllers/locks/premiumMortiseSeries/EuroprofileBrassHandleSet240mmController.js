...
exports.createEuroprofileBrassHandleSet240mm = async (req, res) => {
  try {
    ...
    const product = new EuroprofileBrassHandleSet240mmModel({ ...req.body, photos: photoUrls, category: 'EuroprofileBrassHandleSet240mm' });
    await product.save();
...
exports.updateEuroprofileBrassHandleSet240mm = async (req, res) => {
  try {
    ...
    const product = await EuroprofileBrassHandleSet240mmModel.findOneAndUpdate(
