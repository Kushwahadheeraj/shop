...
exports.createPinCylinderRimLocks = async (req, res) => {
  try {
    ...
    const product = new PinCylinderRimLocksModel({ ...req.body, photos: photoUrls, category: 'PinCylinderRimLocks' });
    await product.save();
...
exports.updatePinCylinderRimLocks = async (req, res) => {
  try {
    ...
    const product = await PinCylinderRimLocksModel.findOneAndUpdate(
