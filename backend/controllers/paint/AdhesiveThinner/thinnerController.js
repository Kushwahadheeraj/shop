...
exports.createThinner = async (req, res) => {
  try {
    ...
    const product = new ThinnerModel({ ...req.body, photos: photoUrls, category: 'thinner' });
    await product.save();
...
/**
 * Update a Thinner product by ID.
 */
exports.updateThinner = async (req, res) => {
  try {
    ...
    const product = await ThinnerModel.findOneAndUpdate(
