...
/**
 * Create a new SolventPrimer product.
 */
exports.createSolventPrimer = async (req, res) => {
  try {
    ...
    const product = new SolventPrimerModel({ ...req.body, photos: photoUrls, category: 'solventPrimer' });
    await product.save();
...
/**
 * Update a SolventPrimer product by ID.
 */
exports.updateSolventPrimer = async (req, res) => {
  try {
    let update = { ...req.body };
    ...
    const product = await SolventPrimerModel.findOneAndUpdate(
...
exports.getAllSolventPrimer = async (req, res) => {
  try {
