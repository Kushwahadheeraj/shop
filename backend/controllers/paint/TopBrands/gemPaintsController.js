...
/**
 * Create a new GemPaints product.
 */
exports.createGemPaints = async (req, res) => {
  try {
    ...
    const product = new GemPaintsModel({ ...req.body, photos: photoUrls, category: 'gemPaints' });
    await product.save();
...
exports.updateGemPaints = async (req, res) => {
  try {
    ...
    const product = await GemPaintsModel.findOneAndUpdate(
