...
exports.createWaterproofBasecoat = async (req, res) => {
  try {
    ...
    const product = new WaterproofBasecoatModel({ ...req.body, photos: photoUrls, category: 'waterproofBasecoat' });
    await product.save();
...
exports.updateWaterproofBasecoat = async (req, res) => {
  try {
    ...
    const product = await WaterproofBasecoatModel.findOneAndUpdate(
