...
/**
 * Create a new Sealer product.
 */
exports.createSealer = async (req, res) => {
  try {
    ...
    const product = new SealerModel({ ...req.body, photos: photoUrls, category: 'sealer' });
    await product.save();
...
/**
 * Update a Sealer product by ID.
 */
exports.updateSealer = async (req, res) => {
  try {
    let update = { ...req.body };
    ...
    const product = await SealerModel.findOneAndUpdate(
...
exports.getAllSealer = async (req, res) => {
  try {
