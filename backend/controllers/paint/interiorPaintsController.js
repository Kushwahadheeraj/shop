...
/**
 * Create a new InteriorPaints product.
 */
exports.createInteriorPaints = async (req, res) => {
  try {
    ...
    const product = new InteriorPaintsModel({ ...req.body, photos: photoUrls, category: 'interiorPaints' });
    await product.save();
...
/**
 * Update a InteriorPaints product by ID.
 */
exports.updateInteriorPaints = async (req, res) => {
  try {
    ...
    const product = await InteriorPaintsModel.findOneAndUpdate(
