...
/**
 * Create a new WallStickersWallpapers product.
 */
exports.createWallStickersWallpapers = async (req, res) => {
  try {
    ...
    const product = new WallStickersWallpapersModel({ ...req.body, photos: photoUrls, category: 'wallStickersWallpapers' });
    await product.save();
...
/**
 * Update a WallStickersWallpapers product by ID.
 */
exports.updateWallStickersWallpapers = async (req, res) => {
  try {
    ...
    const product = await WallStickersWallpapersModel.findOneAndUpdate(
