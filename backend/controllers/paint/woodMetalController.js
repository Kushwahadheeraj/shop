...
/**
 * Create a new WoodMetal product.
 */
exports.createWoodMetal = async (req, res) => {
  try {
    ...
    const product = new WoodMetalModel({ ...req.body, photos: photoUrls, category: 'woodMetal' });
    await product.save();
...
/**
 * Update a WoodMetal product by ID.
 */
exports.updateWoodMetal = async (req, res) => {
  try {
    let update = { ...req.body };
    ...
    const product = await WoodMetalModel.findOneAndUpdate(
...
exports.getAllWoodMetal = async (req, res) => {
  try {
