...
exports.createDoor = async (req, res) => {
  try {
    ...
    const product = new DoorModel({ ...req.body, photos: photoUrls, category: 'door' });
    await product.save();
...
exports.updateDoor = async (req, res) => {
  try {
    ...
    const product = await DoorModel.findOneAndUpdate(
