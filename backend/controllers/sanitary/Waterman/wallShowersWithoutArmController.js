...
exports.createWallShowersWithoutArm = async (req, res) => {
  try {
    ...
    const product = new WallShowersWithoutArmModel({ ...req.body, photos: photoUrls, category: 'wallShowersWithoutArm' });
    await product.save();
...
exports.updateWallShowersWithoutArm = async (req, res) => {
  try {
    ...
    const product = await WallShowersWithoutArmModel.findOneAndUpdate(
