...
exports.createCutters = async (req, res) => {
  try {
    ...
    const product = new ToolsModel({ ...req.body, photos: photoUrls, category: 'cutters' });
    await product.save();
...
/**
 * Get a single Cutters product by ID.
 */
...
/**
 * Delete a Cutters product by ID.
 */
