...
exports.createHacksawBlades = async (req, res) => {
  try {
    ...
    const product = new ToolsModel({ ...req.body, photos: photoUrls, category: 'hacksawBlades' });
    await product.save();
...
/**
 * Get all HacksawBlades products.
 */
...
/**
 * Get a single HacksawBlades product by ID.
 */
...
/**
 * Delete a HacksawBlades product by ID.
 */
