...
/**
 * Create a new Grinders product.
 */
exports.createGrinders = async (req, res) => {
  try {
    ...
    const product = new ToolsModel({ ...req.body, photos: photoUrls, category: 'grinders' });
    await product.save();
...
/**
 * Get a single Grinders product by ID.
 */
...
/**
 * Update a Grinders product by ID.
 */
exports.updateGrinders = async (req, res) => {
  try {
    let update = { ...req.body };
...
/**
 * Delete a Grinders product by ID.
 */
