...
/**
 * Create a new Interiors product.
 */
exports.createInteriors = async (req, res) => {
  try {
    ...
    const product = new ToolsModel({ ...req.body, photos: photoUrls, category: 'interiors' });
    await product.save();
...
/**
 * Get a single Interiors product by ID.
 */
...
/**
 * Update a Interiors product by ID.
 */
exports.updateInteriors = async (req, res) => {
  try {
    let update = { ...req.body };
...
/**
 * Delete a Interiors product by ID.
 */
