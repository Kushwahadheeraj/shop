...
// Fans routes
router.post('/fans', fans.createFan);
...
// Lights routes
router.post('/lights', lights.createLight);
...
// Switches routes
router.post('/switches', switches.createSwitch);
...
// Sockets routes
router.post('/sockets', sockets.createSocket);
...
// Plug routes
router.post('/plug', plug.createPlug);
...
// UniSwitch routes
router.post('/uniSwitch', uniSwitch.createUniSwitch);
...
// TVOutlets routes
router.post('/tVOutlets', tVOutlets.createTVOutlet);
...
router.post('/travelAdaptor', travelAdaptor.createTravelAdaptor);
...
// SwitchPlates routes
router.post('/switchPlates', switchPlates.createSwitchPlate);
...
router.post('/switchAndSocket', switchAndSocket.createSwitchAndSocket);
...
// RotarySwitch routes
router.post('/rotarySwitch', rotarySwitch.createRotarySwitch);
...
// Regulators routes
router.post('/regulators', regulators.createRegulator);
...
// PVCClips routes
router.post('/pvCClips', pvCClips.createPVCClip);
...
// PowerStrips routes
router.post('/powerStrips', powerStrips.createPowerStrip);
...
// PinTop routes
router.post('/pinTop', pinTop.createPinTop);
...
// Others routes
router.post('/others', others.createOther);
...
router.post('/motorStarters', motorStarters.createMotorStarter);
...
// Motors routes
router.post('/motors', motors.createMotor);
...
router.post('/modularSurfaceBox', modularSurfaceBox.createModularSurfaceBox);
...
// MainSwitch routes
router.post('/mainSwitch', mainSwitch.createMainSwitch);
...
// KITKATFuses routes
router.post('/kITKATFuses', kITKATFuses.createKITKATFuse);
...
// Jacks routes
router.post('/jacks', jacks.createJack);
...
// Isolators routes
router.post('/isolators', isolators.createIsolator);
...
router.post('/insulationTapes', insulationTapes.createInsulationTape);
...
// Indicator routes
router.post('/indicator', indicator.createIndicator);
...
// Holders routes
router.post('/holders', holders.createHolder);
...
// FuseCarriers routes
router.post('/fuseCarriers', fuseCarriers.createFuseCarrier);
...
router.post('/flexibleWires', flexibleWires.createFlexibleWire);
...
router.post('/flexibleConduit', flexibleConduit.createFlexibleConduit);
...
router.post('/electricalFittings', electricalFittings.createElectricalFitting);
...
// ELCBsRCCBs routes
router.post('/eLCBsRCCBs', eLCBsRCCBs.createELCBsRCCB);
...
router.post('/earthingAccessories', earthingAccessories.createEarthingAccessory);
...
// DPswitch routes
router.post('/dPswitch', dPswitch.createDPswitch);
...
// DoorBells routes
router.post('/doorBells', doorBells.createDoorBell);
...
router.post('/distributionBoards', distributionBoards.createDistributionBoard);
...
// Dimmer routes
router.post('/dimmer', dimmer.createDimmer);
...
// CeilingRoses routes
router.post('/ceilingRoses', ceilingRoses.createCeilingRoses);
...
router.post('/wiresAndCables', wiresAndCables.createWiresAndCables);
